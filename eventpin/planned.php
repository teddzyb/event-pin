...
<!--------------background------------->
    <style>
        body {
            background-image:url(assets/RED4.jpg);
...
<!-------------the form-------------->
    ...
    <div id="big-container-sec">
        <div id="small-container">
            <h1 class="align">Log in</h1>
            <a href="http://localhost/eventpin/planned.php" class="category btn active"><h5><u>Event Planner</u></h5></a>
            <h5 id="line">|</h5>
            <a href="http://localhost/eventpin/login.php" class="category btn"><h5><u>User</u></h5></a>
        </div>
        <div id="sec-container" class="align">
            ...
            <form action="" method="post" id="arrange">
                ...
                <hr></hr>
                <li id="check-box"><input type="checkbox" id="pwd" name="pwd" value="checked">
                <label for="pwd">Remember Me</label>
                <li><button type="submit" name="submit">Log in</button> <a href="http://localhost/eventpin/planner.php" id="login"><u>Create an Account</u></a></li> 
            </form>
            </ul>
        </div>
    </div>
